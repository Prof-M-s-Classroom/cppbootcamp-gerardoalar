...
Robot robot1("Optimus","Transformer",50);

    // Step 6: Use pointers to access Robot object
Robot* ptr = &robot1;
cout<<"Robot object: "<<ptr<<endl;
...
cout<<"After modifyRobotByReference, Battery Life: "<<robot1.getBatteryLife()<<"%\n";
    ...
    Fleet<string> myFleet2(3);
    myFleet2.addRobot("Twin Cities");
    myFleet2.addRobot("Atom");
    myFleet2.addRobot("Zeus");
    myFleet2.showFleet();
    return 0;
}